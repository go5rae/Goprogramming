...
func main() {
	...
	var f float64
	var G = 99
	// koreanzombie := "정찬성" // 문법적으로 문제없지만 camel 케이스를 사용하는 관례를 따르자
	koreanZombie := "정찬성"
	...
	// var a int = 7 // declar & assign value
	// var a = 7 // declar & assign value
	...
	fmt.Println('Z', '2', '\n', '김', '인', '하') // rune literals(int32) 90, 50, 10, 44608, 51604, 54616
	...
	fmt.Println(strings.Title("open source\tprograming\n\"go\"!"))
